...
- **Raspberry Pi Zero 2 W** running the app as a `systemd` service (Node.js, runs as root). (The project on my actualy bike is an old Zero W with a node 22) but the development here is on a pi 5.
